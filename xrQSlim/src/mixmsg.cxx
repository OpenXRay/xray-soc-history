...
static unsigned int current_indent = 0;
...
static void prefix()
{
    for(unsigned int i=0; i<current_indent; i++)
	error_stream << "    ";
}
...
void mxmsg_indent(unsigned int i) { current_indent += i; }
void mxmsg_dedent(unsigned int i) { current_indent -= i; }
