		...
		case 1:	// box
			{
				...
				// Build points
				A[0].set( -.5f, -.5f, -.5f); A[i].mul(2.f);	Q.transform_tiny	(B[0],A[0]);
				A[1].set( -.5f, -.5f, +.5f); A[i].mul(2.f);	Q.transform_tiny	(B[1],A[1]);
				A[2].set( -.5f, +.5f, +.5f); A[i].mul(2.f);	Q.transform_tiny	(B[2],A[2]);
				A[3].set( -.5f, +.5f, -.5f); A[i].mul(2.f);	Q.transform_tiny	(B[3],A[3]);
				A[4].set( +.5f, +.5f, +.5f); A[i].mul(2.f);	Q.transform_tiny	(B[4],A[4]);
				A[5].set( +.5f, +.5f, -.5f); A[i].mul(2.f);	Q.transform_tiny	(B[5],A[5]);
				A[6].set( +.5f, -.5f, +.5f); A[i].mul(2.f);	Q.transform_tiny	(B[6],A[6]);
				A[7].set( +.5f, -.5f, -.5f); A[i].mul(2.f);	Q.transform_tiny	(B[7],A[7]);
