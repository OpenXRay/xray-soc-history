...
public:
	...
	void					Perform_destroy			(xrServerEntity* tpServerEntity, u32 mode, bool bNotifySimulation = true/** to notify ALife simulator about the changes/**/);

	void					Process_spawn			(NET_Packet& P, DPNID sender, BOOL bSpawnWithClientsMainEntityAsParent=FALSE, xrServerEntity* tpExistedEntity=0);
