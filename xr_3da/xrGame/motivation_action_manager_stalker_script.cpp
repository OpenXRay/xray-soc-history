	...
	[
		class_<CMotivationActionManagerStalker>("stalker_ids")
			...
			[
				...
				luabind::value("property_reach_task_location",				StalkerDecisionSpace::eWorldPropertyReachedTaskLocation),
				luabind::value("property_task_completed",					StalkerDecisionSpace::eWorldPropertyTaskCompleted),
				luabind::value("property_reach_customer_location",			StalkerDecisionSpace::eWorldPropertyReachedCustomerLocation),
			...
			[
				...
				luabind::value("action_no_alife",							StalkerDecisionSpace::eWorldOperatorFreeNoALife),
				luabind::value("action_solve_zone_puzzle",					StalkerDecisionSpace::eWorldOperatorFreeALife),
