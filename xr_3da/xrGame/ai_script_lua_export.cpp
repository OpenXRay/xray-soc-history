...
//			.def("random_dir",					(Fvector & (Fvector::*)())(Fvector::random_dir),																		return_reference_to(self))
//			.def("random_dir",					(Fvector & (Fvector::*)(const Fvector &, float))(Fvector::random_dir),													return_reference_to(self))
//			.def("random_point",				(Fvector & (Fvector::*)(const Fvector &))(Fvector::random_point),														return_reference_to(self))
//			.def("random_point",				(Fvector & (Fvector::*)(float))(Fvector::random_point),																	return_reference_to(self))
