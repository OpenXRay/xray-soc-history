...
void Script::vfExportFvector(CLuaVirtualMachine *tpLuaVirtualMachine)
{
	...
	[
		class_<Fvector>("vector")
			...
			.def("random_dir",					(Fvector & (Fvector::*)(CRandom &))(Fvector::random_dir),return_reference_to(self))
			.def("random_dir",					(Fvector & (Fvector::*)(const Fvector &, float, CRandom &))(Fvector::random_dir),return_reference_to(self))
			.def("random_point",				(Fvector & (Fvector::*)(const Fvector &, CRandom &))(Fvector::random_point),return_reference_to(self))
			.def("random_point",				(Fvector & (Fvector::*)(float, CRandom &))(Fvector::random_point),return_reference_to(self))
...
//			.def("transform_tiny23",			&Fmatrix::transform_tiny23)
			...
			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(Fvector &))(Fmatrix::setXYZ),return_reference_to(self))
			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(float, float, float))(Fmatrix::setXYZ),return_reference_to(self))
			.def("setXYZi",						(Fmatrix & (Fmatrix::*)(Fvector &))(Fmatrix::setXYZi),return_reference_to(self))
