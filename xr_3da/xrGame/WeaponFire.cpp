...
#pragma todo("Dima to Yura : why this branch is not processed?? ¬ылетает на уровне fog_dima если стрельнуть в бетонный блок")
	}
	//статический объект
	else
	{
...
BOOL CWeapon::FireTrace		(const Fvector& P, const Fvector& Peff, Fvector& D)
{
	...
	for(int i = 0; i < l_cartridge.m_buckShot; ++i) 
	{
		...
		//D = dir1;
		//разброс учитыва€ коеффициент дисперсии патрона
...
//нарисовать вспышку пламени из оружи€
