...
#ifndef __XRAY_AI_DOG__
#define __XRAY_AI_DOG__

#include "..\\ai_selector_template.h"
#include "..\\..\\CustomMonster.h"

class CAI_Dog : public CCustomMonster  
{
	protected:
		//////////////////////////
		// STRUCTURES
		...
		enum EDogStates 	{
			aiDogDie = 0,
			aiDogTurn,
			aiDogFreeHuntingActive,
			aiDogFreeHuntingPassive,
			aiDogAttackFire,
			aiDogAttackRun,
			aiDogUnderFire,
			aiDogRetreat,
		...
		typedef struct tagSDogAnimations{
