////////////////////////////////////////////////////////////////////////////
//	Module 		: ai_dog_feel.cpp
//	Created 	: 23.07.2002
//  Modified 	: 07.11.2002
//	Author		: Dmitriy Iassenev
//	Description : Visibility and look for monster "Dog"
////////////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "ai_dog.h"

void CAI_Dog::SetDirectionLook()
{
	int i = ps_Size();
	if (i > 1) {
...
static BOOL __fastcall DogQualifier(CObject* O, void* P)
{
...
objQualifier* CAI_Dog::GetQualifier	()
{
	return(&DogQualifier);
}

void CAI_Dog::feel_sound_new(CObject* who, int eType, Fvector& Position, float power)
{
	if (!g_Alive())
		return;
