...
struct SEntityState {
	...
	Fvector target_pos;		// результирующа€ позици€ обновл€етс€ со стороны Squad
	u32		last_updated;	// врем€ последнего обновлени€ pEnemy со стороны NPC
	u32		last_repos;		// врем€ последнего обновлени€ target_pos со стороны Squad (если 0 - то не брать target_pos)
};
