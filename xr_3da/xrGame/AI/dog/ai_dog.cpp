...
void CAI_Dog::Load(LPCSTR section)
{
	...
	MotionMan.AddAnim(eAnimRunTurnLeft,		"stand_run_turn_left_",	-1, inherited::_sd->m_fsRunFwdDamaged,	inherited::_sd->m_fsRunAngular,			PS_STAND);
	MotionMan.AddAnim(eAnimRunTurnRight,	"stand_run_turn_right_",-1, inherited::_sd->m_fsRunFwdDamaged,	inherited::_sd->m_fsRunAngular,			PS_STAND);
	...
	MotionMan.AddAnim(eAnimJumpLeft,		"stand_jump_left_",		-1, 0,									0,			PS_STAND);
	MotionMan.AddAnim(eAnimJumpRight,		"stand_jump_right_",	-1, 0,									0,			PS_STAND);
