...
//			if (s.time > it->time) it->time = s.time;
//			return;
//		}
//	}
//
...
//
//	
//TSoundDangerValue CSoundMemory::ConvertSoundType(ESoundTypes stype)
//{
...
//
//		if (pE->g_Team() == pThis->g_Team()) {   // труп своего
...
//		if (Enemies[i].time < CurrentTime - MemoryTime){
