...
{
	g_vfLoadSounds(sndIdle,			pSettings->r_string(section,"sound_idle"),			16);
	g_vfLoadSounds(sndEat,			pSettings->r_string(section,"sound_eat"),			16);
	g_vfLoadSounds(sndAttack,		pSettings->r_string(section,"sound_attack"),		16);
	g_vfLoadSounds(sndAttackHit,	pSettings->r_string(section,"sound_attack_hit"),	16);
	g_vfLoadSounds(sndTakeDamage,	pSettings->r_string(section,"sound_take_damage"),	16);
	g_vfLoadSounds(sndDie,			pSettings->r_string(section,"sound_die"),			16);
	g_vfLoadSounds(sndBkground,		pSettings->r_string(section,"sound_bkgnd"),			16);
}
