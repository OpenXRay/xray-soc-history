...
void CMotivationManager<CScriptGameObject>::script_register(lua_State *L)
{
	...
	[
		class_<CScriptMotivationManager,CScriptMotivationManagerWrapper>("motivation_manager")
			...
			.def("reinit",						&CScriptMotivationManagerWrapper::reinit,	&CScriptMotivationManagerWrapper::reinit_static)
			.def("load",						&CScriptMotivationManagerWrapper::Load,		&CScriptMotivationManagerWrapper::Load_static)
			.def("reload",						&CScriptMotivationManagerWrapper::reload,	&CScriptMotivationManagerWrapper::reload_static)
			.def("update",						&CScriptMotivationManagerWrapper::update,	&CScriptMotivationManagerWrapper::update_static)
