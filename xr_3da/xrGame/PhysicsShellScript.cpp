...
void CPhysicsJoint::script_register(lua_State *L)
{
	module(L)
		[
			...
			.def("set_limits_global",					CPhysicsJoint::SetLimits)
			.def("set_limits_vs_first_element",			CPhysicsJoint::SetLimitsVsFirstElement)
			.def("set_limits_vs_second_element",		CPhysicsJoint::SetLimitsVsSecondElement)
