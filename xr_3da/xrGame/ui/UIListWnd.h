...
public:
	...
	// -- Создаем элемент c итерактивными полями --
	...
	// Поля заключенные в проценты будут интерактивными элементками, на которые можно нажать.
	// Так же, в качестве параметра pIDArr должен передаватся массив размерностью не меньше количества
	// интерактивных элементов, с уникальными идентификаторами нажимаемых полей. Эти идентификаторы будут 
	// передаваться указателем pData при при посыле сообщения робительскому окну.
	...
	// Возвращаем вектор уникальных идентификаторов для интерактивных элементов в строке
