...
void CMotivationActionManager<CScriptGameObject>::script_register(lua_State *L)
{
	...
	[
		class_<CScriptMotivationActionManager,CScriptMotivationActionManagerWrapper,bases<CScriptMotivationManager,CScriptActionPlanner> >("motivation_action_manager")
			.def(								constructor<>())
			.def("reinit",						&CScriptMotivationActionManagerWrapper::reinit,	&CScriptMotivationActionManagerWrapper::reinit_static)
			.def("load",						&CScriptMotivationActionManagerWrapper::Load,	&CScriptMotivationActionManagerWrapper::Load_static)
			.def("reload",						&CScriptMotivationActionManagerWrapper::reload,	&CScriptMotivationActionManagerWrapper::reload_static)
			.def("update",						&CScriptMotivationActionManagerWrapper::update,	&CScriptMotivationActionManagerWrapper::update_static)
