	...
	case 0:			//from hit
		{
			...
			if (pWeapon)
			{
				...
				if (pIItem)
				{
					...
					KMS.m_initiator.m_rect.x2 = 50;//KMS.m_initiator.m_rect.x1+pIItem->GetGridWidth()*INV_GRID_WIDTH;
					KMS.m_initiator.m_rect.y2 = 50;//KMS.m_initiator.m_rect.y1+pIItem->GetGridHeight()*INV_GRID_HEIGHT;
