...
#define DECLARE_MONSTER_SOUNDS(A,B)\
	...
	SOUND_TYPE_MONSTER_WALKING_##A			= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_WALKING_NORMAL,\
	SOUND_TYPE_MONSTER_JUMPING_##A			= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_JUMPING_NORMAL,\
