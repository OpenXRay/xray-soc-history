...
#define DECLARE_MONSTER_SOUNDS(A,B)\
	...
	SOUND_TYPE_MONSTER_WALKING_NORMAL_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_WALKING_NORMAL,\
	SOUND_TYPE_MONSTER_WALKING_CROUCH_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_WALKING_CROUCH,\
	SOUND_TYPE_MONSTER_WALKING_LIE_##A		= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_WALKING_LIE,\
	SOUND_TYPE_MONSTER_RUNNING_NORMAL_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_RUNNING_NORMAL,\
	SOUND_TYPE_MONSTER_RUNNING_CROUCH_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_RUNNING_CROUCH,\
	SOUND_TYPE_MONSTER_RUNNING_LIE_##A		= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_RUNNING_LIE,\
	SOUND_TYPE_MONSTER_JUMPING_NORMAL_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_JUMPING_NORMAL,\
	SOUND_TYPE_MONSTER_JUMPING_CROUCH_##A	= SOUND_TYPE_MONSTER_##A | SOUND_TYPE_MONSTER_JUMPING_CROUCH,\
