...
//		case CLSID_AF_MERCURY_BALL:		return xr_new<xrSE_MercuryBall>							(caSection);
		case CLSID_ARTEFACT:			return xr_new<CSE_ALifeItem>								(caSection);

		// Zones
		case CLSID_ZONE:				return xr_new<CSE_ALifeAnomalousZone>						(caSection);
		case CLSID_Z_MBALD:				return xr_new<CSE_ALifeAnomalousZone>						(caSection);
		...
		case CLSID_OBJECT_W_RPG7:		return xr_new<CSE_ALifeItemWeapon>							(caSection);  			// Visualed
