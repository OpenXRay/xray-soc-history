...
void CActionBase<CScriptGameObject>::script_register(lua_State *L)
{
	...
	[
		class_<CScriptActionBase,CScriptActionWrapper>("action_base")
			...
			.def("reinit",						&CScriptActionWrapper::reinit,		&CScriptActionWrapper::reinit_static)
			.def("initialize",					&CScriptActionWrapper::initialize,	&CScriptActionWrapper::initialize_static)
			.def("execute",						&CScriptActionWrapper::execute,		&CScriptActionWrapper::execute_static)
			.def("finalize",					&CScriptActionWrapper::finalize,	&CScriptActionWrapper::finalize_static)
			.def("weight",						&CScriptActionWrapper::weight,		&CScriptActionWrapper::weight_static)
