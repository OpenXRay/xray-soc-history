...
void CAI_Space::q_Range(DWORD StartNode, const Fvector& BasePos, float Range, AI::NodeEstimator& Estimator, DWORD dwLeaderNode)
{
	if (0==vfs)	return;
