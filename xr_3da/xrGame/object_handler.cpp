...
{
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionIdle,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionShow,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionHide,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionTake,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionDrop,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionStrap,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionAim1,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionAim2,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionReload1,	0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionReload2,	0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionFire1,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionFire2,		0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionSwitch1,	0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionSwitch2,	0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionActivate,	0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionDeactivate,0);
	add_state				(xr_new<CObjectStateBase>(),	eObjectActionUse,		0);

	add_transition			(eObjectActionShow,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionHide,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionTake,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionDrop,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionStrap,			eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionAim1,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionAim2,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionReload1,			eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionReload2,			eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionActivate,			eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionDeactivate,		eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionUse,				eObjectActionIdle,		1,		1);
	add_transition			(eObjectActionFire1,			eObjectActionIdle,		1);
	add_transition			(eObjectActionFire2,			eObjectActionIdle,		1);
	add_transition			(eObjectActionSwitch1,			eObjectActionIdle,		1);
	add_transition			(eObjectActionSwitch2,			eObjectActionIdle,		1);
	add_transition			(eObjectActionReload1,			eObjectActionAim1,		1,		1);
	add_transition			(eObjectActionReload2,			eObjectActionAim1,		1,		1);
	add_transition			(eObjectActionReload1,			eObjectActionAim2,		1,		1);
	add_transition			(eObjectActionReload2,			eObjectActionAim2,		1,		1);
	add_transition			(eObjectActionAim1,				eObjectActionAim2,		1,		1);
	add_transition			(eObjectActionFire1,			eObjectActionAim1,		1,		1);
	add_transition			(eObjectActionSwitch1,			eObjectActionAim1,		1);
	add_transition			(eObjectActionAim1,				eObjectActionSwitch2,	1);
	add_transition			(eObjectActionFire2,			eObjectActionAim2,		1,		1);
	add_transition			(eObjectActionSwitch2,			eObjectActionAim2,		1);
	add_transition			(eObjectActionAim2,				eObjectActionSwitch1,	1);

	state(eObjectActionAim1).set_inertia_time(500);
	state(eObjectActionAim2).set_inertia_time(500);
}
...
void CObjectHandler::reinit			()
{
	inherited::reinit				(this,eObjectActionIdle);
}
...
void CObjectHandler::update(const MonsterSpace::EObjectAction &weapon_state)
{
//	inherited::update	(0);
