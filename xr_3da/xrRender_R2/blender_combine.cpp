...
void	CBlender_combine::Compile(CBlender_Compile& C)
{
	...
	case 1:	// level
		...
		break;
	case 2:	// aa-blur
		C.r2_Pass				("null",			r2p("r2_combine_blur"),	FALSE,	FALSE);
		C.r2_Sampler			("s_image",			r2_RT_generic,	D3DTADDRESS_CLAMP,D3DTEXF_LINEAR,D3DTEXF_NONE,D3DTEXF_LINEAR);
		C.r2_End				();
		break;
	case 3:	// aa-edge-detection + AA :)
		...
		C.r2_Sampler_rtf		("s_normal",		r2_RT_N_H);
		C.r2_Sampler			("s_image",			r2_RT_generic,	D3DTADDRESS_CLAMP,D3DTEXF_LINEAR,D3DTEXF_NONE,D3DTEXF_LINEAR);
		C.r2_Sampler			("s_image_aa",		r2_RT_accum,	D3DTADDRESS_CLAMP,D3DTEXF_LINEAR,D3DTEXF_NONE,D3DTEXF_LINEAR);
		C.r2_End				();
		break;
	}
}
