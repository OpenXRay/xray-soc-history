...
Fvector du_cone_vertices[DU_CONE_NUMVERTEX]=
{
	...
	0.4619f,  1.0000f, 0.1913f, 
	0.3536f,  1.0000f, 0.3536f,
	0.1913f,  1.0000f, 0.4619f, 
...
void CRenderTarget::accum_spot_geom_create	()
{
	...
	// vertices
	{
		...
		Memory.mem_copy				(pData,du_cone_vertices,vCount*vSize);
	...
	// Indices
	{
		...
		Memory.mem_copy		(pData,du_cone_faces,iCount*2);
