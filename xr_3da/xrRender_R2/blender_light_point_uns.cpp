...
void	CBlender_accum_point_uns::Compile(CBlender_Compile& C)
{
	...
	{
	case 0:	// masking
		C.r2_Pass				(r2v("r2_accum_point_mask"),	r2p("r2_accum_point_mask"),TRUE,FALSE);
	...
	case 2:
	case 3:
		C.r2_Pass				(r2v("r2_accum_point"),			r2p("r2_accum_point_uns"),FALSE,FALSE,TRUE,D3DBLEND_ONE,D3DBLEND_ONE);
		C.r2_Sampler_rtf		("s_position",		r2_RT_P);
		C.r2_Sampler_rtf		("s_normal",		r2_RT_N_H);
