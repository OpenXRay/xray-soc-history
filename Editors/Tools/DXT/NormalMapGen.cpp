...
{	
	return	color_rgba(
	128+(int(color_get_R(orig))-int(color_get_R(ucomp))),		// R-error
	128+(int(color_get_G(orig))-int(color_get_G(ucomp))),		// G-error
	128+(int(color_get_B(orig))-int(color_get_B(ucomp))),		// B-error
	128+(int(color_get_A(orig))-int(color_get_A(ucomp)))	);	// A-error	
}
