...
{	
	return	color_rgba(
	128+1*(int(color_get_R(orig))-int(color_get_R(ucomp)))/2,		// R-error
	128+1*(int(color_get_G(orig))-int(color_get_G(ucomp)))/2,		// G-error
	128+1*(int(color_get_B(orig))-int(color_get_B(ucomp)))/2,		// B-error
	128+1*(int(color_get_A(orig))-int(color_get_A(ucomp)))/2	);	// A-error	
}
