...
public:
    ...
    int                 GetUnitsCount       (LPCSTR lpSection);
    void                EnumerateItems      (LPCSTR lpSection, int index, LPSTR lpParam, LPSTR lpValue);
    void                SetParam            (LPCSTR lpSection, LPCSTR lpParam);
};
