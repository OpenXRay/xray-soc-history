...
{
    PHelper.CreateFlag<Flags32>	(items, FHelper.PrepareKey(pref,"Common\\Draw Wallmarks"),	&m_Flags, 		flDrawWallmark);
    PHelper.CreateFloat			(items, FHelper.PrepareKey(pref,"Common\\Default Size"),	&m_MarkSize, 	0.01f, 10.f);
    PHelper.CreateAngle			(items, FHelper.PrepareKey(pref,"Common\\Default Rotate"),	&m_MarkRotate);
    PHelper.CreateChoose		(items, FHelper.PrepareKey(pref,"Common\\Default Texture"),	&m_TexName, 	smTexture);
}
//----------------------------------------------------
