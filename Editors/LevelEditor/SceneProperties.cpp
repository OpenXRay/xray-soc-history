...
// Build Options
    ...
    m_BuildParams->area_quality				= rgAreaQuality->ItemIndex+1;
...
// Build Options
    ...
    rgAreaQuality->ItemIndex		= m_BuildParams->area_quality-1;
...
#ifdef _LEVEL_EDITOR
	LPCSTR N;
    if (!TfrmChoseItem::SelectItem(TfrmChoseItem::smObject,N,1,edSkydomeObjectName->Text.c_str())) return;
