		...
		try {
			...
			try {
				...
				for (xrMU_Model::v_faces_it Fit =_beg; Fit!=_end; Fit++)
				{
					...
					// Vertices
					xrMU_Model::_vertex*	_V0		= FF->v[0];	u32 id0	= find(m_vertices.begin(),m_vertices.end(),_V0)-m_vertices.begin();
					xrMU_Model::_vertex*	_V1		= FF->v[1];	u32 id1	= find(m_vertices.begin(),m_vertices.end(),_V1)-m_vertices.begin();
					xrMU_Model::_vertex*	_V2		= FF->v[2];	u32 id2	= find(m_vertices.begin(),m_vertices.end(),_V2)-m_vertices.begin();
