...
MouseCallback_MoveSound::MouseCallback_MoveSound()
	:MouseCallback( TARGET_SOUND, ACTION_MOVE )
{
	m_XVector.set(1,0,0);
	m_YVector.set(0,1,0);
...
bool MouseCallback_MoveSound::Start(){
...
bool MouseCallback_MoveSound::End(){
	return true;
}

void MouseCallback_MoveSound::Move(){
