...
MouseCallback_MoveObject::MouseCallback_MoveObject()
	:MouseCallback( TARGET_OBJECT, ACTION_MOVE )
{
	m_XVector.set(1,0,0);
	m_YVector.set(0,1,0);
...
bool MouseCallback_MoveObject::Start(){
...
bool MouseCallback_MoveObject::End(){
	return true;
}

void MouseCallback_MoveObject::Move(){
