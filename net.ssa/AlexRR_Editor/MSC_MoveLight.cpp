...
MouseCallback_MoveLight::MouseCallback_MoveLight()
	:MouseCallback( TARGET_LIGHT, ACTION_MOVE )
{
	m_XVector.set(1,0,0);
	m_YVector.set(0,1,0);
...
bool MouseCallback_MoveLight::Start(){
...
bool MouseCallback_MoveLight::End(){
	return true;
}

void MouseCallback_MoveLight::Move(){
