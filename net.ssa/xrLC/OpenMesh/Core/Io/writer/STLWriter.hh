...
//
//=============================================================================
// $Id: STLWriter.hh,v 1.8 2004/01/08 15:48:35 openmeshadm Exp $
...
private:
  bool write_stla(FILE*, BaseExporter&, Options) const;
  bool write_stlb(FILE*, BaseExporter&, Options) const;
};
...
typedef SingletonT<_STLWriter_> STLWriter;
