...
#define CSGraphEdge graph_edge<_edge_weight_type,_vertex_type>

TEMPLATE_SPECIALIZATION
IC	CSGraphEdge::graph_edge			(const _edge_weight_type &weight, _vertex_type *vertex)
{
	m_weight		= weight;
	VERIFY			(vertex);
	m_vertex		= vertex;
...
TEMPLATE_SPECIALIZATION
IC	bool CSGraphEdge::operator==	(const graph_edge &obj) const
{
