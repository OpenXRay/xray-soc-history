...
struct 	v2p_in
{
  half3	Pe: 		TEXCOORD0;	// Eye-space position 	(for lighting)
  half3	Ne: 		TEXCOORD1;	// Eye-space normal	(for lighting)
  half2 tc0: 		TEXCOORD2;	// Texture coordinates 	(for sampling diffuse map)
};
