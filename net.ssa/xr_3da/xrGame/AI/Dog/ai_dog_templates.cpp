////////////////////////////////////////////////////////////////////////////
//	Module 		: ai_dog_templates.cpp
//	Created 	: 23.07.2002
//  Modified 	: 07.11.2002
//	Author		: Dmitriy Iassenev
//	Description : Templates for monster "Dog"
////////////////////////////////////////////////////////////////////////////
...
void CAI_Dog::vfSetFire(bool bFire, CGroup &Group)
{
	if (bFire) {
		m_bFiring = true;
...
void CAI_Dog::vfSetMovementType(char cBodyState, float fSpeed)
{
	StandUp();
	m_fSpeed = m_fCurSpeed = fSpeed;
}

void CAI_Dog::vfAdjustSpeed()
{
...
bool CAI_Dog::bfComputeNewPosition(bool bCanAdjustSpeed, bool bStraightForward)
{
...
//	Fvector tAcceledogion;
//	tAcceledogion.setHP(-r_torso_current.yaw,-r_torso_current.pitch);
//	tAcceledogion.normalize_safe();
//	tAcceledogion.mul(m_fSpeed*12.f);
//	Movement.SetPosition(vPosition);
//	Movement.Calculate	(tAcceledogion,0,0,m_fTimeUpdateDelta,false);
