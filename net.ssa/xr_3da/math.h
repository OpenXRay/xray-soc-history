...
#endif
#ifdef M_BORLAND
	NAKED void	BCALL	m24		(void);
	NAKED void	BCALL	m24r	(void);	
	NAKED void	BCALL	m53		(void);	
	NAKED void	BCALL	m53r	(void);	
	NAKED void	BCALL	m64		(void);	
	NAKED void	BCALL	m64r	(void);	
#endif
};
namespace CPU {
...
#endif
#ifdef M_BORLAND
	NAKED	u64	BCALL	GetCycleCount(void);
#endif
};
