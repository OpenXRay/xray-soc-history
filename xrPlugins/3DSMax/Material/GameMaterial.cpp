...
public:
	...
	const TCHAR*	InternalName	()				{ return _T("XRayMtl"); }		// returns fixed parsable name (scripter-visible name)
...
// shader parameters
static ParamBlockDesc2 std2_xray_blk ( std2_xray, _T("xrayParameters"),  0, &stdmtl2CD, P_AUTO_CONSTRUCT + P_AUTO_UI, XRAY_PB_REF, 
									  //rollout
