...
void CAIMapShortestPathNode::begin(u32 dwNode, CAIMapShortestPathNode::iterator &tIterator, CAIMapShortestPathNode::iterator &tEnd)
{
	tEnd = (tIterator = (NodeLink *)((BYTE *)Node(dwNode) + sizeof(NodeCompressed))) + Node(dwNode)->links;
}

u32 CAIMapShortestPathNode::get_value(CAIMapShortestPathNode::iterator &tIterator)
{
