...
void CBoardClassicOthello::show_cell		(const u8 &value) const
{
	char			output;
	switch (value) {
		case WHITE : {
...
IC	bool CBoardClassicOthello::do_move		(const u8 &index)
{
...
bool CBoardClassicOthello::do_move			(const u8 &index)
{
