...
namespace xrLauncher
{
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			// soundPage
			// 
			this->soundPage->BackgroundImage = (__try_cast<System::Drawing::Image *  >(resources->GetObject(S"soundPage.BackgroundImage")));
			...
			this->soundPage->Location = System::Drawing::Point(4, 25);
			this->soundPage->Name = S"soundPage";
			this->soundPage->Size = System::Drawing::Size(357, 243);
			...
			// renderPage
			// 
			this->renderPage->BackgroundImage = (__try_cast<System::Drawing::Image *  >(resources->GetObject(S"renderPage.BackgroundImage")));
			...
			this->renderPage->Location = System::Drawing::Point(4, 25);
			this->renderPage->Name = S"renderPage";
			this->renderPage->Size = System::Drawing::Size(357, 243);
			...
			this->panel1->Size = System::Drawing::Size(840, 324);
			...
			this->panel2->Location = System::Drawing::Point(380, 32);
			this->panel2->Name = S"panel2";
			this->panel2->Size = System::Drawing::Size(416, 272);
			...
			this->ClientSize = System::Drawing::Size(840, 324);
