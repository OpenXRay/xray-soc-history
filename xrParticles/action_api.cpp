...
PARTICLEDLL_API void pGravity(float dir_x, float dir_y, float dir_z, BOOL allow_parent)
{
	PAGravity S;
...
PARTICLEDLL_API void pTargetVelocity(float vel_x, float vel_y, float vel_z, float scale, BOOL allow_parent)
{
	PATargetVelocity S;
